const content = {
  ...
  ru: {
    ...
    acclimatize: {
      ...
      routeOneText: "Сильный маршрут для акклиматизации: высота, ровный темп и ощущение настоящего высокогорья. На вершине видны остатки старой обсерватории, но главное здесь — рельеф, воздух и большие панорамы Тейде.",
