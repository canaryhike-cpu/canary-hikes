const content = {
  ...
  ru: {
    ...
    permits: {
      ...
      miniRoute: "PNT 07 или PNT 09",
      miniRouteText: "В зависимости от выбранного подъема.",
    ...
    acclimatize: {
      ...
      title: "Перед Тейде стоит сделать маршрут для высоты.",
      copy: "Восхождение на Тейде начинается выше 2500 м, где многие уже чувствуют высоту. Один подготовительный маршрут поможет проверить темп, дыхание и самочувствие перед ночным стартом.",
      routeOne: "Маршрут на гору Гуахара",
      routeOneText: "На хребте рядом с Гуахарой в начале XX века работал астроном Жан Маскар: в 1910 году он проводил здесь наблюдения кометы Галлея и предлагал создать международную обсерваторию.",
  ...
  document.querySelector("main").innerHTML = `
    <section class="shop-hero">
      ...
      <div class="shop-hero-content">
        ...
        ${pageData.hero.copy ? `<p class="hero-copy">${pageData.hero.copy}</p>` : ""}
