const content = {
  ...
  ru: {
    ...
    hero: {
      ...
      title: "Руководство по восхождению на Тейде",
      copy: "Практические советы: маршрут, разрешения, парковки, канатная дорога, варианты спуска и особенности высоты.\n\nЭто серьёзный подъём, к которому необходима подготовка. Мы прошли этот маршрут и собрали для вас все рекомендации. Желаем вам тоже сделать это и встретить уникальный рассвет на вершине действующего вулкана.",
    ...
    permits: {
      ...
      pnt10Title: "PNT 10: тропа Telesforo Bravo", pnt10Text: "На этот маршрут также требуется разрешение. Это финальный участок подъёма от La Rambleta к кратеру.",
    ...
    cable: {
      ...
      list: ["Первая кабина вниз обычно около 09:00. В зависимости от сезона после рассвета может потребоваться ожидание открытия канатной дороги. Например, в августе ожидание может достигать почти двух часов.", "Билеты нужно покупать заранее.", "Канатку могут закрыть из-за ветра.", "Всегда держите запасной план пешего спуска."],
    ...
    acclimatize: {
      ...
      title: "Перед восхождением на Тейде стоит пройти акклиматизационный маршрут.",
