const content = {
  ...
  ru: {
    ...
    hero: {
      ...
      title: "Хайкинг-маршруты по Канарским островам без случайных решений",
      copy: "Готовые маршруты, логистика, парковки, точки старта и честные подсказки — чтобы идти в горы спокойно, а не собирать план из десятка приложений.",
      imageAlt: "Рассвет над облаками на маршруте восхождения на Тейде на Тенерифе",
      cta: "Выбрать маршрут", panelLabel: "Вершина", panelText: "Высшая точка Испании и Атлантических островов."
    },
    quick: {
  ...
  ru: {
    hiking: {
      ...
      hero: {
        ...
        copy: "<strong>Преимущества:</strong><br>• Самостоятельно: идёте в своём ритме и не зависите от группы.<br>• Безопасно: мы прошли каждый маршрут, проверили треки и инструкции — вы можете уверенно им следовать.<br>• Проверено: рекомендуем только лучшие маршруты острова, потому что прошли их лично и отобрали самые сильные.<br>• Легко подготовиться: в каждом гайде даём полную подготовку от и до — всё, что нужно перед стартом.",
